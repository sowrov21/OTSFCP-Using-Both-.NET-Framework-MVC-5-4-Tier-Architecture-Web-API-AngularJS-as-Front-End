app.controller("PostControllerStudent",function($scope,ajax,$location,$sessionStorage){
    ...
    app.controller("PostControllerAddStudent",function($scope,ajax,$location,$sessionStorage){
